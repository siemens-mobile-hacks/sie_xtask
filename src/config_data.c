...
#ifndef NEWSGOLD
__root int ACTIVE_KEY = 99;
#else
    #ifdef ELKA
    __root int ACTIVE_KEY = 0x15;
    #else
    __root int ACTIVE_KEY = 0x11;
    #endif
#endif

__root CFG_HDR cfghdr5 = {CFG_CBOX, "Extra: on longpress", 0, 5};
__root int ENA_LONG_PRESS = 2;
